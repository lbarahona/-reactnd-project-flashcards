  ...
  render() {
    return (<KeyboardAvoidingView style={styles.container} behaviour="padding">
      ...
      <View style={{
        ...
        <FormInput onChangeText={this.handleChange} value={this.state.question} inputStyle={{
            width: '100%'
          }}/>
      </View>
      ...
      <View style={{
        ...
        <Button raised icon={{
            ...
            type: 'ionicon',
            size: 35
          }} title='Submit' backgroundColor='#397af8' borderRadius={30} onPress={this.handleSubmit}/>
      </View>
